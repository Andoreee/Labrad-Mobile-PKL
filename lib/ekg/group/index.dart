...
import 'package:labrad_pkl2022/ekg/group/search.dart';
import 'package:labrad_pkl2022/ekg/group/update.dart';
import 'dart:convert';
import '../../nav_drawer.dart';

class GroupEkg extends StatefulWidget {
  GroupEkg({super.key});
  static const String routeName = "/ekg/group";

  @override
  State<GroupEkg> createState() => _GroupEkgState();
}

class _GroupEkgState extends State<GroupEkg> {
  ...
  Widget build(BuildContext context) {
          ...
          rows: EkgGroup.map(
            (group) => DataRow(cells: [
              ...
              DataCell(Row(
                ...
                children: [
                  UpdateEkgGroup.widgetUpdateEkgGroup(
                      context, group['grup'], group['idgrup']),
    ...
    return Scaffold(
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                ...
                SearchEkgGroup.searchInputEkgGroup(context),
                InkWell(
                  onTap: () {
                    // print(_fecthDataUsers().then((value) => print(value)));
                    Navigator.popAndPushNamed(context, GroupEkg.routeName);
                  },
                  child: Container(
                    width: 100,
      ...
      floatingActionButton:
          SizedBox(child: CreateEkgGroup.widgetCreateEkgGroup(context)),
    );
  }
}
